$('#save,#update').on("click",function (e) {
    ...
    if(this_id=="save")  //Save start
    {
					...
					///if(confirm("Do You Wants to Save Record ?")){
                        ...
                        console.log(" data from rental js "+data);
              ...
              //alert(result);return;
							if(result=="success")
							{
								...
								window.location=base_url+'rental_items';//"items-view.php";
								return;
							}
	...
	else if(this_id=="update")  //Save start
    {
					...
					///if(confirm("Do You Wants to Update Record ?")){
						...
						$.ajax({
						type: 'POST',
						url: base_url+'rental_items/update_items?existing_row_count='+existing_row_count,
						data: data,
						cache: false,
						contentType: false,
						processData: false,
              ...
              //alert(result);return;
							if(result=="success")
							{
								window.location=base_url+'rental_items';
							}
							else if(result=="failed")
							{
							   toastr["error"]("Sorry! Failed to save Record.Try again!");
...
function delete_items(q_id)
{
   ...
   if(confirm("Do You Wants to Delete Record ?")){
   	$(".box").append('<div class="overlay"><i class="fa fa-refresh fa-spin"></i></div>');
    $.post($("#base_url").val()+"rental_items/delete_items",{q_id:q_id},function(result){
   //alert(result);return;
	   if(result=="success")
				{
				  toastr["success"]("Record Deleted Successfully!");
