...
class Sales extends MyPDF{
	...
	public function show_rental_pdf()
	{
		$this->_rental_main_body();
	}

    public function _rental_main_body()
	{
	        $sales = $this->rental;//array()
    		$store 		= $this->store;//array()
    		$customer 	= $this->customer;//array()

    		$this->_invoice_name = "Rental Invoice";
    		...
    		$this->_set_document_number($sales->rental_code);
    		...
    		<table >';
    		    ...
    		    $tbl .='<thead>
    		        <tr style="background-color: #e4eaff ;" class="text-bold">
    			        ...
    			        <th colspan="1" style="width: '.$colW['price'].'">Price</th>';
    			        if($show_tax){
    			        ...
    			        <th colspan="1" style="width: '.$colW['disc amt'].'">Dis. Amt.</th>
    			        <th colspan="1" style="width: '.$colW['unit cost'].'">Unit Cost</th>
    		    ...
    		    <tbody>';
                  ...
                  $this->CI->db->select(" a.description,c.item_name, a.rent_qty,a.tax_type,
                                      a.price_per_unit, b.tax,b.tax_name,a.tax_amt,
                                      a.discount_input,a.discount_amt, a.unit_total_cost,
                                      a.total_cost ,c.sku,c.hsn
                                  ");
                  $this->CI->db->where("a.sales_id",$this->sales_id);
                  $this->CI->db->from("db_renteditems a");
                  $this->CI->db->join("db_tax b","b.id=a.tax_id","left");
                  $this->CI->db->join("db_rentalitems c","c.id=a.item_id","left");
                  //$this->CI->db->limit("10");
                  ...
                  $q2=$this->CI->db->get();
    		        ...
    		        foreach ($q2->result() as $res2) {
                      ...
                      $tot_cost_before_tax=$before_tax * $res2->rent_qty;
