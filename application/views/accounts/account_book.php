              ...
              <div class="box-header ">
                ...
                <div class="row">
                  ...
                  <div class="col-md-12">
                    ...
                    <div class="col-md-3">
                      <div class="form-group">
                        <label for="users">Total :</label></label>
                        <input type="text" class="form-control pull-right" id="total" name="total" readonly>
                        <span id="users_msg" style="display:none" class="text-danger"></span>
                      </div>
                    </div>
      ...
      var table = $('#example2').DataTable({
        ...
        "ajax": {
          ...
          "dataSrc": function(json) {
            // You can access custom values here
            // $('#totalAmountDisplay').text("Total Amount: " + json.totalAmount);
            document.getElementById("total").value = json.totalCredit - json.totalDebit;
            console.log(json.totalDebit + " - " + json.totalCredit);
            return json.data; // Important: this returns the actual data for the table
          },
  ...
  <script>
    ...
    function delete_transaction(q_id, entry_of) {
      ...
      if (confirm("Are you Sure ?\nIt will Delete Real Payments entry as well!!")) {
        ...
        $.post(base_url + "account_transactions/delete_transaction", {
          q_id: q_id,
          entry_of: entry_of
        }, function(result) {
          result = result;
