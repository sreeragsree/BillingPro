	...
	<table width="95%" align="center">
		<tr>
			<td align="center" width="40%" style="padding: 5px 0;">
				<img src="<?= base_url($store_logo);?>" width="70%" height="auto" style="max-width: 300px;">
			</td>
		</tr>
		<tr>
			<td align="center">
                ...
                <strong><?= $store_name; ?></strong><br>
					...
					<?php echo '( Composition Dealer )'; echo "<br>"; ?> 
			...
			<td>
				...
				<table width="100%" cellpadding="0" cellspacing="0"  >
					...
					<tr style="border-top-style: dashed;border-bottom-style: dashed;border-width: 0.1px;">
						...
						<?php  } ?>
						<th style="font-size: 11px; text-align: right;padding-left: 2px; padding-right: 2px;">Sale Price</th>
					...
					<tbody style="border-bottom-style: dashed;border-width: 0.1px;">
						<?php
			              ...
			              $this->db->select(" a.description,c.mrp,c.item_name, a.sales_qty,a.tax_type,
                                  ...
                                  a.total_cost , d.unit_name,c.sku,c.hsn,bat.sales_price
                              ");
...
//			              for selecting batch
			              $this->db->join("db_batches bat","a.batch_id = bat.id","left");
			              $q2=$this->db->get();
			              foreach ($q2->result() as $res2) {
			                  ...
			                  echo "<td style='text-align: right;padding-left: 2px; padding-right: 2px;'>".store_number_format($res2->sales_price)."</td>";
...
<?php if(isset($other_charges_amt) && $other_charges_amt > 0) { 
    $other_charges_label = (!empty(trim($other_charges_input)) && is_string($other_charges_input)) ? trim($other_charges_input) : 'Other Charges';
    // Ensure we have a valid string label
    if (empty($other_charges_label) || is_numeric($other_charges_label)) {
        $other_charges_label = 'Other Charges';
    }
?>
    <tr>
        <td style="padding-left: 2px; padding-right: 2px;" colspan="<?=$mrp_column+4?>" align="right"><?= html_escape($other_charges_label); ?></td>
...
<?php } ?>
					...
					<tr>
						<td colspan="<?=$mrp_column+5?>" align="center"><?= $this->lang->line('bill_for_return'); ?></td>
					</tr>
  ...
  <div style="margin: 10px 0;">
    <img src="<?= base_url('theme/dist/img/payQr.png') ?>" alt="QR Code" style="width: 120px; height: 120px; display: block; margin: 0 auto;">
  </div>
