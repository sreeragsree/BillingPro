...
<!--                                        <input type="checkbox" name="show_account_receivable" id='show_account_receivable'> --><?php //= $this->lang->line('view_account_receivable_customers'); ?>
<!--                                    </label>-->
<!--                                </div>-->
                            </div>
...
<!--                                        <i class="fa fa-plus"></i> --><?php //= $this->lang->line('create_customer'); ?><!--</a>-->
<!--                                </div>-->
<!--                            --><?php //} ?>
                        </div>
                        <!-- /.box-header -->
