...
<aside class="main-sidebar">
  ...
  <section class="sidebar">
    ...
    <ul class="sidebar-menu">
      ...
      <!-- menus for customization module -->

      <!-- customer order -->
      <?php if (!is_user()) { ?>
        <?php if ($CI->permissions('order_form')  || $CI->permissions('order_list')) { ?>
          <!-- <li class="header">SALES</li> -->
          <li class="pos-active-li sales-list-active-li sales-active-li sales-return-active-li sales-return-list-active-li sales-payments-list-active-li treeview">
            <a href="#">
              <i class=" fa fa-book text-aqua"></i> <span><?= $this->lang->line('customization'); ?></span>
              <span class="pull-right-container">
                <i class="fa fa-angle-left pull-right"></i>
              </span>
            </a>
            <ul class="treeview-menu">
              ...
              <?php if ($CI->permissions('order_form')) { ?>
                ...
                <li class="sales-active-li"><a href="<?php echo $base_url; ?>customer_order/add"><i class="fa fa-plus-square-o "></i> <span><?= $this->lang->line('order_form'); ?></span></a></li>

              <?php } ?>

              <?php if ($CI->permissions('order_list')) { ?>
                <li class="sales-list-active-li"><a href="<?php echo $base_url; ?>customer_order"><i class="fa fa-list "></i> <span><?= $this->lang->line('order_list'); ?></span></a></li>
              <?php } ?>
      ...
      <!-- Rental system -->
      <?php if (!is_user()) { ?>
        <?php if ($CI->permissions('add_rental')  || $CI->permissions('rental_list') || $CI->permissions('search_items')) { ?>
          <!-- <li class="header">SALES</li> -->
          <li class="pos-active-li sales-list-active-li sales-active-li sales-return-active-li sales-return-list-active-li sales-payments-list-active-li treeview">
            <a href="#">
              <i class=" fa fa-book text-aqua"></i> <span><?= $this->lang->line('rental'); ?></span>
              <span class="pull-right-container">
                <i class="fa fa-angle-left pull-right"></i>
              </span>
            </a>
            <ul class="treeview-menu">
              ...
              <?php if ($CI->permissions('add_rental')) { ?>

                <li class="sales-active-li"><a href="<?php echo $base_url; ?>rental_items/add"><i class="fa fa-plus-square-o "></i> <span><?= $this->lang->line('add_item'); ?></span></a></li>
                <li class="sales-active-li"><a href="<?php echo $base_url; ?>rental_items"><i class="fa fa-plus-square-o "></i> <span><?= $this->lang->line('items_list'); ?></span></a></li>
                <li class="sales-active-li"><a href="<?php echo $base_url; ?>rental/add_rental"><i class="fa fa-plus-square-o "></i> <span><?= $this->lang->line('add_rental'); ?></span></a></li>

              <?php } ?>

              <?php if ($CI->permissions('search_items')) { ?>

                <li class="sales-active-li hide"><a href="<?php echo $base_url; ?>rental_items/search_items"><i class="fa fa-search"></i> <span><?= $this->lang->line('search_items'); ?></span></a></li>

              <?php } ?>

              <?php if ($CI->permissions('rental_list')) { ?>
                <li class="sales-list-active-li"><a href="<?php echo $base_url; ?>rental"><i class="fa fa-list "></i> <span><?= $this->lang->line('rental_list'); ?></span></a></li>
              <?php } ?>
      ...
      <!-- rooms and hall booking -->
      <?php if (!is_user()) { ?>
        <?php if ($CI->permissions('sales_add')  || $CI->permissions('sales_view') || $CI->permissions('sales_return_view') || $CI->permissions('sales_return_add')) { ?>
          <!-- <li class="header">SALES</li> -->
          <li class="pos-active-li sales-list-active-li sales-active-li sales-return-active-li sales-return-list-active-li sales-payments-list-active-li treeview">
            <a href="#">
              <i class=" fa fa-book text-aqua"></i> <span><?= $this->lang->line('bookings'); ?></span>
              <span class="pull-right-container">
                <i class="fa fa-angle-left pull-right"></i>
              </span>
            </a>
            <ul class="treeview-menu">
              ...
              <?php if ($CI->permissions('sales_add')) { ?>
                ...
                <li class="sales-active-li"><a href="<?php echo $base_url; ?>sales/add"><i class="fa fa-plus-square-o "></i> <span><?= $this->lang->line('add_booking'); ?></span></a></li>

              <?php } ?>

              <?php if ($CI->permissions('sales_view')) { ?>
                <li class="sales-list-active-li"><a href="<?php echo $base_url; ?>sales"><i class="fa fa-list "></i> <span><?= $this->lang->line('booking_list'); ?></span></a></li>
              <?php } ?>
      ...
      <!-- menus for customization module close -->
      ...
      <?php if ($CI->permissions('help_link')) { ?>
        <li hidden><a href="<?php echo $base_url; ?>help/" target="_blank"><i class="fa fa-book text-green"></i> <span><?= $this->lang->line('help'); ?></span></a></li>
      <?php } ?>
    </ul>
  </section>
  <!-- /.sidebar -->
