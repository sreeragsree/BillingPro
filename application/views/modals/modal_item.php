      ...
      <div class="modal-body">
        ...
        <div class="row">
          ...
          <div class="col-md-4">
            <div class="box-body">
              <div class="form-group">
                <label for="m_mrp">Whole Sale Price<i class="hover-q " data-container="body" data-toggle="popover" data-placement="top" data-html="true" data-trigger="hover" data-original-title=""></label>
                <input type="text" maxlength="10" class="form-control maxlength only_currency " id="m_wholesaleprice" name="m_wholesaleprice" placeholder="Wholesale Price">
              </div>
            </div>
          </div>
          ...
          <div class="col-md-4">
            <div class="box-body">
              <div class="form-group">
                <label for="m_mrp">Alphabet Price<i class="hover-q " data-container="body" data-toggle="popover" data-placement="top" data-html="true" data-trigger="hover" data-original-title=""></label>
                <input type="text" maxlength="10" class="form-control maxlength " id="m_alphabetprice" name="m_alphabetprice" placeholder="Alphabet Price">
              </div>
            </div>
          </div>
          ...
          <div class="col-md-4">
            <div class="box-body">
              <div class="form-group">
                <label for="m_mrp">Batch Name<i class="hover-q " data-container="body" data-toggle="popover" data-placement="top" data-html="true" data-trigger="hover" data-original-title=""></label>
                <input type="text" maxlength="10" class="form-control maxlength " id="m_batchname" name="m_batchname" placeholder="Alphabet Price">
              </div>
            </div>
          </div>
          ...
          <div class="col-md-4">
            <div class="box-body">
              <div class="form-group">
                <label for="m_mrp">Seller Code<i class="hover-q " data-container="body" data-toggle="popover" data-placement="top" data-html="true" data-trigger="hover" data-original-title=""></label>
                <input type="text" class="form-control maxlength " id="m_sellercode" name="m_sellercode" placeholder="Alphabet Price">
              </div>
            </div>
          </div>
          ...
          <div class="col-md-4">
            <div class="box-body">
              <div class="form-group">
                <label for="m_mrp">Seller Name<i class="hover-q " data-container="body" data-toggle="popover" data-placement="top" data-html="true" data-trigger="hover" data-original-title=""></label>
                <input type="text" class="form-control maxlength " id="m_sellername" name="m_sellername" placeholder="Alphabet Price">
              </div>
            </div>
          </div>
