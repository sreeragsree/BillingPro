...
<body class="hold-transition skin-blue sidebar-mini">
   <div class="wrapper">
      ...
      if (isset($sales_id)) {
         ...
         $invoice_terms = $store_details->rental_terms;
         $save_operation = true;
      } else {
         //NEW
      ...
      <div class="content-wrapper">
         ...
         <section class="content-header">
            <h1>
               <?= $page_title; ?>
               <small>Add/Update Rental</small>
            </h1>
            <ol class="breadcrumb">
               <li><a href="<?php echo $base_url; ?>dashboard"><i class="fa fa-dashboard"></i> Home</a></li>
               <li><a href="<?php echo $base_url; ?>rental">Rental List</a></li>
               <li><a href="<?php echo $base_url; ?>rental/add_rental">New Rental</a></li>
            ...
            <div class="row">
               ...
               <div class="col-md-12">
                  ...
                  <div class="box box-primary ">
                     ...
                     <!-- form start -->
                     <!-- OK START -->
                     <?= form_open('#', array('class' => 'form-horizontal', 'id' => 'rental-form', 'enctype' => 'multipart/form-data', 'method' => 'POST')); ?>
                     ...
                     <div class="box-body">
                        ...
                        <div class="form-group">
                           ...
                           <label for="init_code" class="col-sm-2 control-label">Rental Code<label class="text-danger">*</label></label>
                        ...
                        <div class="form-group">
                           ...
                           <label for="sales_date" class="col-sm-2 control-label"> Rental Date <label class="text-danger">*</label></label>
                           <div class="col-sm-3">
                        ...
                        <div class="form-group">
                           ...
                           <div class="col-sm-3">
                              <div class="input-group date">
                                 ...
                                 <input min="<?= date('Y-m-d'); ?>" required type="text" class="form-control pull-right datepicker" id="due_date" name="due_date" value="<?= $due_date; ?>">
                              </div>
                                          ...
                                          <table class="table table-hover table-bordered" style="width:100%" id="sales_table">
                                             <thead class="custom_thead">
                                                <tr class="bg-primary">
                                                   ...
                                                   <th rowspan='2' style="width:10%;min-width: 180px;">Color</th>
                                                   <th rowspan='2' style="width:10%;min-width: 180px;">Size</th>
                     ...
                     <div class="box-footer col-sm-12">
                        <center>
                           ...
                           <div class="col-md-3 col-md-offset-3">
                              <button accesskey="s" type="button" id="<?php echo $btn_id; ?>" class="btn btn-block btn-success payments_modal" title="Save Data"><?php echo $btn_name; ?></button>
                           </div>
   ...
   <script src="<?php echo $theme_link; ?>js/rental.js"></script>
            ...
            $.get(base_url + "purchase/get_item_details_with_batch_and_productid", {
               ...
               function(result) {
                  ...
                  if (Object.keys(jsonData).length <= 1) {
                     ...
                     $('#tr_item_id_' + row_id).val(jsonData.pro_id);
                     $('#tr_data_' + row_id + "_13").val(jsonData.quantity);
                     $('#td_data_' + row_id + "_10").val(jsonData.sales_price);
         ...
         if ((subtotal != null || subtotal != '') && (subtotal != 0)) {
            ...
            if (discount_input > 0) {
               ...
               if (discount_type == 'in_fixed') {
                  ...
                  //minus discount input from the taxable value 
                  if (discount_input < taxable) {
                     taxable -= discount_input;
                     discount = discount_input;
                  } else {
                     toastr['warning']("Discount amount should be less than total amount");
                     document.getElementById('discount_to_all_input').value = '';
                  }
