        ...
        <th colspan="18">
          <table width="100%" height='100%' class="style_hidden fixed_table">
              <tr>
                <!-- First Half -->
<!--                <td colspan="4">-->
<!--                  <img src="--><?php //= base_url($store_logo);?><!--" width='100%' height='auto'>-->
<!--                </td>-->
...
<tbody>
 ...
 foreach ($q2->result() as $res2) {
                  ...
                  echo "<td colspan='2' class='text-left'>".$res2->batch_no."</td>";
...
<tfoot>
  ...
  <tr>
    <td colspan="16" class='text-right'><b><?= $this->lang->line('subtotal'); ?></b></td>
    <td colspan="2" class='text-right' ><b><?php echo store_number_format($tot_total_cost); ?></b></td>
  </tr>


  <tr>
    <td colspan="16" class='text-right'><b><?= $this->lang->line('other_charges'); ?></b></td>
    <td colspan="2" class='text-right' ><b><?php echo store_number_format($other_charges_amt); ?></b></td>
  </tr>
  
  <tr>
    <td colspan="16" class='text-right'><b><?= $this->lang->line('discount_on_all'); ?>(<?= store_number_format($discount_to_all_input)." ".$discount_to_all_type; ?>)</b></td>
    <td colspan="2" class='text-right' ><b><?php echo store_number_format($tot_discount_to_all_amt); ?></b></td>
  </tr>
  
  <tr>
    <td colspan="16" class='text-right'><b><?= $this->lang->line('grand_total'); ?></b></td>
