...
$q3 = $this->db->query("SELECT b.coupon_id,b.coupon_amt, b.created_by,b.store_id,a.customer_name,a.mobile,a.phone,a.gstin,
                           a.tax_number,a.email,a.delete_bit,b.rental_note,
                           a.opening_balance,a.country_id,a.state_id,
                           a.postcode,a.address,b.rental_date,b.created_time,b.reference_no,
                           b.rental_code,b.rental_note,a.rental_due,
...
$sales_date = show_date($res3->rental_date);
$reference_no = $res3->reference_no;
$created_time = show_time($res3->created_time);
$sales_code = $res3->rental_code;
$sales_note = '';
// $customer_delete_bit=$res3->delete_bit;
// $invoice_terms=nl2br($res3->invoice_terms);

$previous_due = $res3->rental_due - ($res3->grand_total - $res3->paid_amount);//$res3->customer_previous_due;
$previous_due = ($previous_due > 0) ? $previous_due : 0;
$total_due = $res3->rental_due;//$res3->customer_total_due;
    ...
    <tr>
        <td align="center">
                ...
                <strong><?= $store_name; ?></strong><br>
		            ...
		            <br>
		            <?php echo (!empty(trim($company_gst_no)) && gst_number()) ? 'GSTIN : ' . $company_gst_no . "<br>" : ''; ?>
                    <?php echo '( Composition Dealer )';
                    echo "<br>"; ?>
        ...
        <td>
            ...
            <table width="100%" cellpadding="0" cellspacing="0">
                ...
                <tr style="border-top-style: dashed;border-bottom-style: dashed;border-width: 0.1px;">
                    ...
                    <?php if ($mrp_column) { ?>
                        <th style="font-size: 11px; text-align: right;padding-left: 2px; padding-right: 2px;"></th>
                    <?php } ?>
                ...
                $this->db->select(" a.description,c.mrp,c.item_name, a.rent_qty,a.tax_type,
                                  a.price_per_unit, b.tax,b.tax_name,a.tax_amt,
                                  a.discount_input,a.discount_amt, a.unit_total_cost,
                                  a.total_cost , d.unit_name,c.sku,c.hsn
                              ");
                $this->db->where("a.rent_id", $sales_id);
                $this->db->from("db_renteditems a");
                $this->db->join("db_tax b", "b.id=a.tax_id", "left");
                $this->db->join("db_rentalitems c", "c.id=a.item_id", "left");
                ...
                foreach ($q2->result() as $res2) {
                    ...
                    echo "<td style='text-align: center;padding-left: 2px; padding-right: 2px;'>" . format_qty($res2->rent_qty) . "</td>";
                    if ($mrp_column) {
                        echo "<td style='text-align: right;padding-left: 2px; padding-right: 2px;'></td>";
                    }
                ...
                <tr hidden>
                    ...
                    <td style=" padding-left: 2px; padding-right: 2px;"
                        align="right"><?= store_number_format($before_tax); ?></td>
                </tr>
                ...
                if (get_store_details()->pos_invoice_format_id == 1) {
                    ...
                    <tr hidden>
                        ...
                        <td style=" padding-left: 2px; padding-right: 2px;"
                            align="right"><?= store_number_format($tax_amt); ?></td>
                    </tr>
                        ...
                        foreach ($q5->result() as $row) {
                            ...
                            if ($customer_delete_bit == 1 || (strtoupper($customer_state) == strtoupper($company_state))) {
                                ...
                                <tr>
                                    ...
                                    <td style=" padding-left: 2px; padding-right: 2px;"
                                        align="right"><?= store_number_format($cgst_amt); ?></td>
                                </tr>
                                <tr>
                                    <td style=" padding-left: 2px; padding-right: 2px;" colspan="<?= $mrp_column + 4 ?>"
                                        align="right">
                                    ...
                                    <td style=" padding-left: 2px; padding-right: 2px;"
                                        align="right"><?= store_number_format($sgst_amt); ?></td>
                                </tr>
                                ...
                                <tr>
                                    ...
                                    <td style=" padding-left: 2px; padding-right: 2px;"
                                        align="right"><?= store_number_format($igst_amt); ?></td>
                                </tr>
                                <?php
                ...
                <?php if (!empty($coupon_code)) { ?>
                    <tr>
                        <td style=" padding-left: 2px; padding-right: 2px;" colspan="<?= $mrp_column + 4 ?>"
                            align="right"><?= $this->lang->line('couponDiscount'); ?> <?= ($coupon_type == 'Percentage') ? $coupon_value . '%' : '[Fixed]'; ?></td>
                        <td style=" padding-left: 2px; padding-right: 2px;"
                            align="right"><?= store_number_format($coupon_amt); ?></td>
                    </tr>
                <?php } ?>
                ...
                <?php if (!empty($tot_discount_to_all_amt) && $tot_discount_to_all_amt != 0) { ?>
                    <tr>
                        <td style=" padding-left: 2px; padding-right: 2px;" colspan="<?= $mrp_column + 4 ?>"
                            align="right"><?= $this->lang->line('discount'); ?> <?= ($discount_to_all_type == 'in_percentage') ? $discount_to_all_input . '%' : '[Fixed]'; ?></td>
                        <td style=" padding-left: 2px; padding-right: 2px;"
                            align="right"><?= store_number_format($tot_discount_to_all_amt); ?></td>
                    </tr>
                <?php } ?>
                ...
                <tr>
                    ...
                    <td style=" padding-left: 2px; padding-right: 2px;"
                        align="right"><?= store_number_format($grand_total); ?></td>
                </tr>
                <tr>
                    <td style=" padding-left: 2px; padding-right: 2px;" colspan="<?= $mrp_column + 4 ?>"
                        align="right"><?= $this->lang->line('tot_discounted_amt'); ?></td>
                    <td style=" padding-left: 2px; padding-right: 2px;"
                        align="right"><?= store_number_format($overall_discounted); ?></td>
                </tr>
                ...
                <?php if (change_return_status()) {
                    ...
                    <tr>
                        ...
                        <td style=" padding-left: 2px; padding-right: 2px;"
                            align="right"><?= store_number_format($paid_amount + $change_return_amount); ?></td>
                    </tr>
                    <tr>
                        <td style=" padding-left: 2px; padding-right: 2px;" colspan="<?= $mrp_column + 4 ?>"
                            align="right"><?= $this->lang->line('refund'); ?></td>
                        <td style=" padding-left: 2px; padding-right: 2px;"
                            align="right"><?= store_number_format($change_return_amount); ?></td>
                    </tr>
                <?php } else { ?>
                    <tr>
                        <td style=" padding-left: 2px; padding-right: 2px;" colspan="<?= $mrp_column + 4 ?>"
                            align="right"><?= $this->lang->line('paid_amount'); ?></td>
                        <td style=" padding-left: 2px; padding-right: 2px;"
                            align="right"><?= store_number_format($paid_amount); ?></td>
                    </tr>
                ...
                <?php if ($previous_balance_bit == 1) { ?>
                    <tr>
                        <td style=" padding-left: 2px; padding-right: 2px;" colspan="<?= $mrp_column + 4 ?>"
                            align="right"><?= $this->lang->line('previous_due'); ?></td>
                        <td style=" padding-left: 2px; padding-right: 2px;"
                            align="right"><?= store_number_format($previous_due); ?></td>
                    </tr>
                    <tr>
                        <td style=" padding-left: 2px; padding-right: 2px;" colspan="<?= $mrp_column + 4 ?>"
                            align="right"><?= $this->lang->line('total_due_amount'); ?></td>
                        <td style=" padding-left: 2px; padding-right: 2px;"
                            align="right"><?= store_number_format($total_due); ?></td>
                    </tr>
                <?php } ?>
                <?php if (!empty($coupon_code)) { ?>
                    <tr>
                ...
                <!-- show rental instructions here -->
                <tr>
                    <td colspan="<?= $mrp_column + 5 ?>" align="left">
                        <?php
                        $q33 = $this->db->query("SELECT rental_terms FROM db_store a WHERE a.id=" . get_current_store_id());
                        $res33 = $q33->row();
                        $rental_conditions = $res33->rental_terms;

                        $conditions = explode('|', $rental_conditions);
                ...
                <tr>
                    <td colspan="<?= $mrp_column + 5 ?>"
                        align="center"><?= $this->lang->line('bill_for_return'); ?></td>
                </tr>


                <tr>
                    <td colspan="<?= $mrp_column + 5 ?>" align="left">
                        <table style="border:1px solid;border-collapse:collapse;" width="100%" cellpadding="0"
                               cellspacing="0">
                            <tr>
                            ...
                            <?php
                            if (isset($sales_id)) {
                                $q4 = $this->db->query("select * from db_rentalpayments where rental_id=$sales_id");
                                if ($q4->num_rows() > 0) {
                                    $i = 1;
                                    $total_paid = 0;
                ...
                if ($t_and_c_status_pos) { ?>
                    ...
                    <tr style='border:1px solid;'>
                        <td colspan="<?= $mrp_column + 5 ?>" align="left">
                            <b><u><?= $this->lang->line('invoiceTerms'); ?>:</u></b>
                            <i><?= nl2br(get_invoice_terms_for_pos()); ?></i>
                        </td>
                    </tr>
                <?php }
                ?>
                <tr>
                    <td colspan="<?= $mrp_column + 5 ?>" align="center">
                        ----------<?= $this->lang->line('thanks_you_visit_again'); ?>----------
                    </td>
                </tr>
