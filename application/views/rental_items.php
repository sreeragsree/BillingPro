...
<body class="hold-transition skin-blue  sidebar-mini">
   ...
   <div class="wrapper">
      ...
      if (!isset($item_name)) {
         ...
         $item_code = get_init_code('rental_item');
      } else {
      ...
      <div class="content-wrapper">
         ...
         <section class="content-header">
            ...
            <ol class="breadcrumb">
               ...
               <li><a href="<?php echo $base_url; ?>rental_items">Rental Items List</a></li>
                     ...
                     <div class="box-body">
                        ...
                        <div class="row">
                           ...
                           <div class="form-group col-md-4">
                            ...
                            <!-- color -->
                           <div class="form-group col-md-4">
                              <label for="custom_barcode">Color</label>
                              <input value="<?php print $color; ?>" type="text" class="form-control " id="color" name="color" placeholder="" >
                              <span id="custom_barcode_msg" style="display:none" class="text-danger"></span>
                           </div>

                           <!-- for size -->
                           <div class="form-group col-md-4">
                              <label for="custom_barcode">Size</label>
                              <input value="<?php print $size; ?>" type="text" class="form-control " id="size" name="size" placeholder="">
                              <span id="custom_barcode_msg" style="display:none" class="text-danger"></span>
                           </div>
                        ...
                        <div class="row">
                           ...
                           <div class="form-group col-md-4">
                              <label for="sales_price" class="control-label">Rental Price<span class="text-danger">*</span></label>
                              <input type="text" class="form-control only_currency " id="rental_price" name="rental_price" placeholder="Sales Price" value="<?php print $sales_price; ?>">
                           ...
                           <div type="hidden" class="form-group col-md-4">
                           ...
                           <div class="form-group col-md-4">
                              <label for="batch_no"><?= $this->lang->line('batch_no'); ?>
                              </label>
                        ...
                        <div style="display: none;" class="row variant_div">
                           <div class="col-md-12">
   ...
   <script src="<?php echo $theme_link; ?>js/rental_items.js"></script>
