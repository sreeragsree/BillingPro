                                    ...
                                    <table class="table table-bordered">
                                      ...
                                      <tbody>
                                       ...
                                       <tr>
                                        ...
                                        <tr>
                                          <td><?= $i++;?></td>
                                          <td><?= $this->lang->line('customization'); ?></td>
                                          <td>
                                              <div class="checkbox icheck"><label>
                                                <input type="checkbox" class="change_me" id="customization"> <?= $this->lang->line('select_all'); ?>
                                              </label></div>
                                          </td>
                                          <td>
                                              <input type="hidden" name="module[customization]" value="on">
                                              
                                              <div class="checkbox icheck"><label>
                                                <input type="checkbox" class="customization_all" id='order_form' name="permission[order_form]"> <?= $this->lang->line('order_form'); ?>
                                              </label></div>

                                              <div class="checkbox icheck"><label>
                                                <input type="checkbox" class="customization_all" id='order_list' name="permission[order_list]"> <?= $this->lang->line('order_list'); ?>
                                              </label></div>
                                        ...
                                        <tr>
                                          <td><?= $i++;?></td>
                                          <td><?= $this->lang->line('rental'); ?></td>
                                          <td>
                                              <div class="checkbox icheck"><label>
                                                <input type="checkbox" class="change_me" id="rental"> <?= $this->lang->line('select_all'); ?>
                                              </label></div>
                                          </td>
                                          <td>
                                              <input type="hidden" name="module[rental]" value="on">
                                              
                                              <div class="checkbox icheck"><label>
                                                <input type="checkbox" class="rental_all" id='add_rental' name="permission[add_rental]"> <?= $this->lang->line('add_rental'); ?>
                                              </label></div>

                                              <div class="checkbox icheck"><label>
                                                <input type="checkbox" class="rental_all" id='rental_list' name="permission[rental_list]"> <?= $this->lang->line('rental_list'); ?>
                                              </label></div>

                                              <div class="checkbox icheck"><label>
                                                <input type="checkbox" class="rental_all" id='search_items' name="permission[search_items]"> <?= $this->lang->line('search_items'); ?>
                                              </label></div>
                                        ...
                                        <tr>
                                          <td><?= $i++;?></td>
                                          <td><?= $this->lang->line('bookings'); ?></td>
                                          <td>
                                              <div class="checkbox icheck"><label>
                                                <input type="checkbox" class="change_me" id="bookings"> <?= $this->lang->line('select_all'); ?>
                                              </label></div>
                                          </td>
                                          <td>
                                              ...
                                              <div class="checkbox icheck"><label>
                                                <input type="checkbox" class="bookings_all" id='add_booking' name="permission[add_booking]"> <?= $this->lang->line('add_booking'); ?>
                                              </label></div>

                                              <div class="checkbox icheck"><label>
                                                <input type="checkbox" class="bookings_all" id='booking_list' name="permission[booking_list]"> <?= $this->lang->line('booking_list'); ?>
                                              </label></div>

                                          </td>
                                        </tr>
                                        
                                        <!-- customization permissions  close -->
